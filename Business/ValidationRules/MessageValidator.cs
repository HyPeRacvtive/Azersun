...
namespace Business.ValidationRules
{
    public class MessageValidator : AbstractValidator<Messages>
    {
        ...
        {
            RuleFor(x => x.Name).NotEmpty().WithMessage("Lütfen Adınızı Yazınız");
            RuleFor(x => x.SurName).NotEmpty().WithMessage("Lütfen Soy Adınızı Yazınız");
            ...
            RuleFor(x => x.Name).MinimumLength(2).WithMessage("Lütfen Adınızı Doğru Biçimde Giriniz (En Az 2 Karakter)");
            RuleFor(x => x.Name).MaximumLength(20).WithMessage("Lütfen Adınızı Doğru Biçimde Giriniz(En Fazla 20 Karakter)");
